...
- (IBAction)onClickQueryHistoryTrackButton:(UIButton *)sender {
    ...
    // 将FirstView dowork中entityNameLabel中的text赋值给SecondView中的entityName
    ...
    [[BTRACEAction shared] getTrackHistory:self serviceId:serviceId entityName:@"pegion0705" startTime:[startTime intValue] endTime:[endTime intValue] simpleReturn:1 isProcessed:1 pageSize:5000 pageIndex:1];
    });
    _historyMapView.hidden = false;
}
